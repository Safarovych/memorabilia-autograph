...
export default function Site() {
  ...
  return <main className="premiumHome">
    ...
    <section className="categoryStrip">{cats.map((name,i)=><Link href="/shop" key={name} className="categoryPhotoCard"><span className={`categoryPhoto categoryPhoto-${i}`}></span><b>{name}</b></Link>)}</section>
